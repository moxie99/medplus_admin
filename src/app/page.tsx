...
const features = [
  ...
  },
  {
    ...
    description:
      'Find the perfect drug in seconds with our powerful search engine.',
  },
  {
    icon: ShoppingCart,
...
const testimonials = [
  {
    name: 'John Doe',
    comment:
      "Medplus has revolutionized how I shop for utilities. It's so convenient!",
  },
  {
    name: 'Jane Doe',
    comment:
  ...
  return (
    <div className='min-h-screen'>
      <header className='container mx-auto px-4 py-6 flex justify-between items-center'>
        ...
        <Link href='/auth' className='hover:underline' prefetch={false}>
          Log In
        </Link>
      </header>
      ...
      <main className='container mx-auto px-4 py-12'>
            ...
            <div className='md:w-1/2 mb-8 md:mb-0'>
              <MotionWrapper>
                <h2 className='text-4xl md:text-6xl font-bold mb-4'>
                  Discover Drugs on the Go
                </h2>
              </MotionWrapper>
              <MotionWrapper delay={0.2}>
                <p className='text-xl  mb-6'>
                  Shop the latest utilities and original drugs right from your
                  pocket with our innovative mobile app.
                </p>
              </MotionWrapper>
              <MotionWrapper delay={0.4}>
                <Button size='lg' className='bg-[#ff0077] hover:bg-[#ff0077]'>
            ...
            <div className='w-1/3'>
              ...
              >
                <Image
                  ...
                  height={888}
                  src='/app-pics.png'
                  alt='Medplus Screenshot'
                  className='rounded-3xl object-cover shadow-2xl mx-auto h-[500px] w-[250px]'
                />
                <Badge className='absolute top-4 right-4 bg-[#ff0077] text-white'>
                  New Release
                </Badge>
              </motion.div>
            </div>
        ...
        <section className='mb-24'>
          <Card className='bg-[#ff0077] text-white'>
            <CardContent className='p-8 text-center'>
              <h3 className='text-3xl font-bold mb-4'>
                Download Medplus Today
              </h3>
              <p className='text-xl mb-6'>
                Experience the future of utilities shopping at your fingertips.
              </p>
        ...
        <section className='text-center'>
          <h3 className='text-3xl font-bold mb-4'>
            Ready to Transform Your utilities Shopping?
          </h3>
          <p className='text-xl  mb-8'>
            Download Medplus now and get 20% off your first in-app purchase!
          </p>
          <Button size='lg' className='bg-[#ff0077] hover:bg-[#ff0077]'>
      ...
      <footer className='bg-[#ff0077] text-white'>
        <Link
